...
export class Init1756380506932 implements MigrationInterface {
  name = 'Init1756380506932';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "task_list" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "userId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e9f70d01f59395c1dfdc633ae37" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    // Seed root role
    await queryRunner.query(`
            INSERT INTO "role" ("id", "roleName", "accessPermissions", "navPermissions", "appPermissions")
            VALUES (1, 'root', ARRAY['root']::text[], ARRAY['root']::text[], ARRAY['root']::text[])
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "username" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'active', "email" character varying, "password" character varying NOT NULL, "salt" character varying NOT NULL, "refreshTokens" text array NOT NULL DEFAULT ARRAY[]::text[], "appTokens" text array NOT NULL DEFAULT ARRAY[]::text[], CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "note" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying, "userId" character varying NOT NULL, CONSTRAINT "PK_96d0c172a4fba276b1bbed43058" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
