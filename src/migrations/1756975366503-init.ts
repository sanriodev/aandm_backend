...
export class Init1756975366503 implements MigrationInterface {
  name = 'Init1756975366503';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "role" ("id" SERIAL NOT NULL, "roleName" character varying NOT NULL, "accessPermissions" text array NOT NULL DEFAULT ARRAY[]::text[], "navPermissions" text array NOT NULL DEFAULT ARRAY[]::text[], "appPermissions" text array NOT NULL DEFAULT ARRAY[]::text[], CONSTRAINT "UQ_a6142dcc61f5f3fb2d6899fa264" UNIQUE ("roleName"), CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "task" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying, "isDone" boolean NOT NULL DEFAULT false, "taskListId" integer NOT NULL, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "task_list" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "privacyMode" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, "lastModifiedUserId" integer NOT NULL, CONSTRAINT "PK_e9f70d01f59395c1dfdc633ae37" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "note" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying, "privacyMode" integer NOT NULL DEFAULT '0', "userId" integer NOT NULL, "lastModifiedUserId" integer NOT NULL, CONSTRAINT "PK_96d0c172a4fba276b1bbed43058" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NOT NULL, "email" character varying, "password" character varying NOT NULL, "salt" character varying NOT NULL, "refreshTokens" text array NOT NULL DEFAULT ARRAY[]::text[], "appTokens" text array NOT NULL DEFAULT ARRAY[]::text[], CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "task_list" ADD CONSTRAINT "FK_d34f2d64706c6a8188a6446678b" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "task_list" ADD CONSTRAINT "FK_42a51ce9182439e733b5e89dd33" FOREIGN KEY ("lastModifiedUserId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "note" ADD CONSTRAINT "FK_db01555cc30a654df2fa24566e1" FOREIGN KEY ("lastModifiedUserId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "note" DROP CONSTRAINT "FK_db01555cc30a654df2fa24566e1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "note" DROP CONSTRAINT "FK_5b87d9d19127bd5d92026017a7b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "task_list" DROP CONSTRAINT "FK_42a51ce9182439e733b5e89dd33"`,
    );
    await queryRunner.query(
